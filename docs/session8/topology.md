...
| 2 | R1 | Fa1/20 | PC-B | NIC | 172.16.10.0/24 (VLAN 10) |
| 3 | R1 | Fa1/30 | PC-C | NIC | 172.16.20.0/24 (VLAN 20) |
| 4 | R1 | Fa0/1 | R2 | Fa0/0 | 10.1.12.0/30 |
| 5 | R2 | Fa0/1 | R3 | Fa0/0 | 10.1.23.0/30 |
| 6 | R3 | Fa1/30 | PC-D | NIC | 172.16.30.0/24 (VLAN 30) |
| 7 | R3 | Fa1/40 | PC-E | NIC | 172.16.40.0/24 (VLAN 40) |
...
|--------|------|-----------------|
| R1 | Left-site router — VLAN 10 and VLAN 20 | Fa1/10, Fa1/20 (VLAN 10 access); Fa1/30 (VLAN 20 access); Fa0/1 (WAN to R2) |
| R2 | Hub router — OSPF, ACL enforcement | Fa0/0 (WAN to R1); Fa0/1 (WAN to R3) |
| R3 | Right-site router — VLAN 30 and VLAN 40 | Fa1/30 (VLAN 30 access); Fa1/40 (VLAN 40 access); Fa0/0 (WAN to R2) |
| PC-A | Left-site Sales host | VPCS on R1 Fa1/10 |
| PC-B | Left-site Sales host | VPCS on R1 Fa1/20 |
| PC-C | Left-site Management host | VPCS on R1 Fa1/30 |
| PC-D | Right-site Sales host | VPCS on R3 Fa1/30 |
| PC-E | Right-site Management host | VPCS on R3 Fa1/40 |
