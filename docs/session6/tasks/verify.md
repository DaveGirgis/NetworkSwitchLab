...
| 5 | OSPF | R1 routing table has OSPF routes | `show ip route ospf` on R1 | O entries for 192.168.2.0/24, 192.168.3.0/24, 10.0.23.0/29 |
...
| 11 | EIGRP | R1 routing table has EIGRP routes | `show ip route eigrp` on R1 | D entries for 192.168.2.0/24, 192.168.3.0/24, 10.0.23.0/29 |
